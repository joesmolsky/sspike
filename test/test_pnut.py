...
def test_snowglobes_events():
    key_list = ['smeared_weighted', 'unsmeared_weighted',
                'smeared_unweighted', 'unsmeared_unweighted']
    column_list = ['Energy', 'ibd', 'nue_C12', 'nue_C13',
                   'nuebar_C12', 'nc', 'e']
...
def test_sspike_events():
    ...
    column_list = ['T_p', 'E_vis', 'E_min', 'nc_nue_p', 'nc_nuebar_p',
                   'nc_nux_p', 'nc_nuxbar_p', 'nc_p']
    close = 1e-6
